...
A única solução é um chamado ao Support do GitHub; o chamado precisa nomear os
dois repositórios (upstream e fork). O rewrite sem contato com Support é ilusão
de remover dados.
...
funcionando; mesmo assim, o rewrite sozinho não bastou, porque forks compartilham
o object store.
