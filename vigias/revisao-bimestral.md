...
2. Se as tools do claude-mem estiverem disponíveis, busque observações das
   últimas 8 semanas sobre onde as regras da skill funcionaram ou falharam
   (termos: foco, planta, ideia, escopo, rainforest). Resuma em 3 bullets.
   Se não estiverem, pule sem falhar.
