...
mutacao:
  ...
  emenda 2026-09-08: a T8 provou que `--add-dir` não reabre `.git` no sandbox do Codex; a flag saiu do script e o caso 2 passou a exigir a AUSÊNCIA dela (ver emenda do design). O "pronto quando" abaixo lê-se com essa troca.
