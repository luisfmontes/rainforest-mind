...
// `posicoesDeOperadorHeredoc`, `EXECUTAM_ARQUIVO`,
// `alvoDoRedirecionamentoEhExecutadoDepois` e `mascararCorposDeHeredoc`
// moraram aqui ate a Issue #263 (zerar-issues-5, tarefa 2); mudaram para
// `hooks/lib/heredoc.cjs` (importada acima) para `gate-mensagem-commit.cjs`
// poder reusar a mesma mascara sem duplicar a logica.
